...
public class RectangleTues {
    private String name;
    private int length;
    private int width;

    public RectangleTues() {

    }

    public RectangleTues(String name, int length, int width) {
        this.name = name;
    ...
    public RectangleTues findMaxArea(List<RectangleTues> rectangles, ComparatorTues com) {
        RectangleTues rectangle = new RectangleTues();

        for (RectangleTues rec : rectangles) {
    ...
    public RectangleTues findMaxPerimeter(List<RectangleTues> rectangles, ComparatorTues com) {
        RectangleTues rectangle = new RectangleTues();
